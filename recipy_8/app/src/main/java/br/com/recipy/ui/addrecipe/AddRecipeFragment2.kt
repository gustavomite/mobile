...
import br.com.recipy.ui.adapter.IngredientAdapter
...
class AddRecipeFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        ingrList.adapter = IngredientAdapter(viewModel.recipe)
        ...
        buttonAdd.setOnClickListener {
            if (ingrName.text.isNullOrBlank() || ingrQty.text.isNullOrBlank()) {
                ...
                viewModel.recipe.ingredient[id] = ingrQty.text.toString()
